    ...
    <x-public.container>
        <div class="py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <!-- Logo e tagline -->
                <div class="space-y-4">
                    <x-public.brand-logo class="h-8 filter brightness-0 invert" />
                    <p class="text-sm text-neutral-400">La cura della pelle, ridefinita.</p>
                ...
                <!-- Naviga -->
                <div>
                    <h4 class="font-semibold mb-4">Naviga</h4>
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="/supporto" class="text-neutral-400 hover:text-white transition-colors">Supporto</a></li>
                ...
                <!-- Legale -->
                <div>
                    <h4 class="font-semibold mb-4">Legale</h4>
                    <ul class="space-y-2 text-sm">
                        <li><a href="/privacy-policy" class="text-neutral-400 hover:text-white transition-colors">Privacy Policy</a></li>
                        <li><a href="/termini-di-servizio" class="text-neutral-400 hover:text-white transition-colors">Termini di Servizio</a></li>
                        <li><a href="/cookie-policy" class="text-neutral-400 hover:text-white transition-colors">Cookie Policy</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-2 text-sm text-neutral-400">
                        <p>P.IVA 11863510019</p>
                        <p>Strada Santa Vittoria 11<br>10024 Moncalieri (TO)</p>
                        <a href="mailto:info@skintemple.it" class="block hover:text-white transition-colors">info@skintemple.it</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Bottom bar -->
        <div class="border-t border-neutral-800 py-6 flex flex-col md:flex-row justify-between items-center">
            <p class="text-sm text-neutral-400">
                &copy; {{ date('Y') }} SkinTemple. Tutti i diritti riservati.
            </p>
            
            @if(config('skintemple.einvoice_badge_enabled', false))
            <div class="mt-4 md:mt-0">
                <span class="text-xs text-neutral-500">Fatturazione elettronica abilitata</span>
            </div>
            @endif
        </div>
    </x-public.container>
